...
$err=$firstname = $mail = $password = $lastname = $address = $city =$state = $postal =$phone = $business ="";
...
if (empty($err)) {
 ...
 $sql = "INSERT INTO Business (firstname, surname, registration_number, address, city, state, postal_code, phone_num, username, password, logo, business_type) VALUES ('$firstname', '$lastname', NULL, '$address', '$city', '$state','$postal','$phone','$mail','$password', NULL, '$business');";
$sql .= "INSERT INTO Login (username, password, role) VALUES ('$mail', '$password','business');";
