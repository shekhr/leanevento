...
<div id="container">
    ...
    <div class="images-aboutus">
     ...
     <form action="profilebusiness.php" name = "RegForm" onsubmit="return validation()" class="register" method="post">
        <h1>Registro</h1>
        <fieldset class="row1">
        ...
        <fieldset class="row2">
            ...
            <p>
                <input type="radio" name="business" value="1"> Tipo de negocio 1<br>
                <input type="radio" name="business" value="2"> Tipo de negocio 2<br>
                <input type="radio" name="business" value="3"> Tipo de negocio 3<br>
            </p>
