...
if (empty($err)) {
$sql = "INSERT INTO Agent (firstname, surname, registration_number, address, city, state, postal_code, phone_num, username, password, logo) VALUES ('$firstname', '$lastname', NULL, '$address', '$city', '$state', '$postal','$phone','$mail', '$password', NULL);";
$sql .= "INSERT INTO Login (username, password, role) VALUES ('$mail', '$password','agent');";
