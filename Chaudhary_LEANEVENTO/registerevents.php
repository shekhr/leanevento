...
<div id="container">
    ...
    <div class="container">
        ...
        <form action="registerevents.php" name = "RegForm" onsubmit="return validation()" method="post">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if(empty($errName)){
 $sql = "INSERT INTO EventSelection (event_name, responsible, place, date, time, price, value, commission) VALUES ('$eventName','$responsible','$place','$date','$time','$price','$value','$comiss')";
  ...
  echo '<script>window.alert("Enter all the values");</script>';
}
}
